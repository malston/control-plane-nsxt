resource "nsxt_lb_service" "control_plane_lb_service" {
  ...
  virtual_server_ids = ["${nsxt_lb_tcp_virtual_server.concourse_credhub_lb_virtual_server.id}", "${nsxt_lb_tcp_virtual_server.concourse_uaa_lb_virtual_server.id}", "${nsxt_lb_tcp_virtual_server.concourse_lb_virtual_server.id}","${nsxt_lb_tcp_virtual_server.minio_lb_virtual_server.id}"]
